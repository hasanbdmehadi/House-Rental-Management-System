<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="Details.aspx.cs" Inherits="WebAppDynamicProject.Detailsn" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:DynamicDataManager ID="DynamicDataManager1" runat="server" AutoLoadForeignKeys="true" />

    <h2>Details of <%= table.DisplayName %></h2>
    
    <div id="navigation" >
	<input type="button" value="Print Document" 
		onclick="window.open('/test.aspx')" style="font-size: xx-large;  font-weight:bold;" /> 
	</div><br />
