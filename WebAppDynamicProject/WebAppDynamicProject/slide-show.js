            ...
            jQuery.each(f.setting, function(a) {
                if (f.setting[a] instanceof Array) {
                    for (var b = 0; b < f.setting[a].length; b++) {
                        if (f.setting[a][b].tagName == "DIV")
                            f.setting[a][b].innerHTML = null; f.setting[a][b] = null
                    }
                }
            });
            f = f.setting = null
...
(function(a, b) {
    ...
    function o(a, b) {
        var c = {}; q.each(bT.concat.apply([], bT.slice(0, b)),
function() { c[this] = a }); return c
    ...
    function n(a, b, c) {
        ...
        { e = true; if (f = q.fragments[a[0]]) if (f !== 1) d = f } if (!d) { d = b.createDocumentFragment(); q.clean(a, b, d, c) }
        if (e) q.fragments[a[0]] = f ? d : 1; return { fragment: d, cacheable: e }
    } function m(a, b) {
    ...
    function l(a) { return !a || !a.parentNode || a.parentNode.nodeType === 11 }
    function k(a, b) { return "live." + (a && a !== "*" ? a + "." : "") + b.replace(/\./g, "`").replace(/ /g, "&") }
    function j(a) {
        var b, c = [], d = [], e = arguments, f, g, h, i, j, k; g = q.data(this, "events");
        if (!(a.liveFired === this || !g || !g.live || a.button && a.type === "click")) {
            ...
            for (k = f.length; j < k; j++)
                ...
                if (f[j].selector === g.selector) {
                    ...
                    if (!d || d !== h) c.push({ elem: h, handleObj: g })
                }
            } j = 0;
            for (k = c.length; j < k; j++) {
                f = c[j];
                a.currentTarget = f.elem;
                a.data = f.handleObj.data; a.handleObj = f.handleObj;
                if (f.handleObj.origHandler.apply(f.elem, e) === false) { b = false; break }
            } return b
        }
    }
    function i(a, b, c) {
    ...
    { return true } function g() { return false }
    ...
    function d(a, b) {
        b.src ? q.ajax({ url: b.src, async: false, dataType: "script" }) : q.globalEval(b.text || b.textContent || b.innerHTML || "");
        b.parentNode && b.parentNode.removeChild(b)
    }
    function c() {
        if (!q.isReady) {
            try { t.documentElement.doScroll("left") } catch (a) {
                setTimeout(c, 1);
                return
            } q.ready()
        }
...
r = a.jQuery, s = a.$, t = a.document, u, v = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, w = /^.[^:#\[\.,]*$/,
x = /\S/, y = /^(\s|\u00A0)+|(\s|\u00A0)+$/g, z = /^<(\w+)\s*\/?>(?:<\/\1>)?$/,
A = navigator.userAgent, B = false, C = [], D,
E = Object.prototype.toString, F = Object.prototype.hasOwnProperty, G = Array.prototype.push,
H = Array.prototype.slice, I = Array.prototype.indexOf; q.fn = q.prototype = { init: function(a, c) {
    var d, e; if (!a) return this; if (a.nodeType) { this.context = this[0] = a; this.length = 1; return this }
    if (a === "body" && !c) {
        this.context = t; this[0] = t.body; this.selector = "body"; this.length = 1;
        return this
    } if (typeof a === "string")
        if ((d = v.exec(a)) && (d[1] || !c)) if (d[1]) {
        e = c ? c.ownerDocument || c : t;
        if (a = z.exec(a)) if (q.isPlainObject(c)) { a = [t.createElement(a[1])]; q.fn.attr.call(a, c, true) }
        else a = [e.createElement(a[1])]; else {
            a = n([d[1]], [e]);
        ...
        if (c = t.getElementById(d[2])) {
            if (c.id !== d[2]) return u.find(a); this.length = 1;
            this[0] = c
        } this.context = t; this.selector = a;
        return this
    } else if (!c && /^\w+$/.test(a)) {
        this.selector = a; this.context = t; a = t.getElementsByTagName(a);
        return q.merge(this, a)
    } else return !c || c.jquery ? (c || u).find(a) : q(c).find(a);
    else if (q.isFunction(a)) return u.ready(a);
    if (a.selector !== b)
    { this.selector = a.selector; this.context = a.context } return q.makeArray(a, this)
},
    selector: "", jquery: "1.4.2", length: 0, size: function() { return this.length }, toArray: function()
    { return H.call(this, 0) },
    get: function(a) { return a == null ? this.toArray() : a < 0 ? this.slice(a)[0] : this[a] },
    pushStack: function(a, b, c) {
        var d = q(); q.isArray(a) ? G.apply(d, a) : q.merge(d, a);
        d.prevObject = this; d.context = this.context;
        if (b === "find") d.selector = this.selector + (this.selector ? " " : "") + c;
        else if (b) d.selector = this.selector + "." + b + "(" + c + ")"; return d
    }, each: function(a, b)
    { return q.each(this, a, b) }, ready: function(a) {
        q.bindReady();
        if (q.isReady) a.call(t, q);
        else C && C.push(a);
        return this
    }, eq: function(a)
    { return a === -1 ? this.slice(a) : this.slice(a, +a + 1) }, first: function()
    { return this.eq(0) }, last: function() { return this.eq(-1) }, slice: function()
    { return this.pushStack(H.apply(this, arguments), "slice", H.call(arguments).join(",")) }, map: function(a)
    { return this.pushStack(q.map(this, function(b, c) { return a.call(b, c, b) })) }, end: function()
    { return this.prevObject || q(null) }, push: G, sort: [].sort, splice: [].splice
};
    q.fn.init.prototype = q.fn; q.extend = q.fn.extend = function() {
        var a = arguments[0] || {}, c = 1, d = arguments.length, e = false, f, g, h, i;
        if (typeof a === "boolean") { e = a; a = arguments[1] || {}; c = 2 }
        if (typeof a !== "object" && !q.isFunction(a)) a = {}; if (d === c) { a = this; --c }
        for (; c < d; c++) if ((f = arguments[c]) != null) for (g in f) {
            h = a[g]; i = f[g]; if (a !== i)
                if (e && i && (q.isPlainObject(i) || q.isArray(i)))
            { h = h && (q.isPlainObject(h) || q.isArray(h)) ? h : q.isArray(i) ? [] : {}; a[g] = q.extend(e, h, i) }
            else if (i !== b) a[g] = i
        } return a
    }; q.extend({ noConflict: function(b) {
        a.$ = s; if (b) a.jQuery = r;
        return q
    }, isReady: false, ready: function() {
        if (!q.isReady) {
            if (!t.body) return setTimeout(q.ready, 13);
            q.isReady = true; if (C) { for (var a, b = 0; a = C[b++]; ) a.call(t, q); C = null }
        ...
        bindReady: function() {
            if (!B) {
                ...
                if (t.addEventListener) {
                    ...
                    a.attachEvent("onload", q.ready); var b = false;
                    try { b = a.frameElement == null } catch (d) { } t.documentElement.doScroll && b && c()
                }
            }
        },
        isFunction: function(a) { return E.call(a) === "[object Function]" }, isArray: function(a)
        { return E.call(a) === "[object Array]" }, isPlainObject: function(a) {
    ...
    (function() {
        ...
        var i = q.isFunction(a); return this.each(function(b) {
            var c = q(this), d = a; if (this.nodeType === 1) {
                ...
                if (q.isArray(d) && T.test(this.type)) this.checked = q.inArray(c.val(), d) >= 0;
                    ...
                    var e = q.makeArray(d); q("option", this).each(function() { this.selected = q.inArray(q(this).val(), e) >= 0 });
    ...
    q.extend({ attrFn: { val: true, css: true, html: true, text: true, data: true, width: true, height: true, offset: true },
        attr: function(a, c, d, e) {
            if (!a || a.nodeType === 3 || a.nodeType === 8) return b;
            if (e && c in q.attrFn) return q(a)[c](d); e = a.nodeType !== 1 || !q.isXMLDoc(a);
            var f = d !== b; c = e && q.props[c] || c; if (a.nodeType === 1) {
                var g = P.test(c);
                if (c in a && e && !g) {
                    if (f) {
                    ...
                    if (c === "tabIndex")
                        return (c = a.getAttributeNode("tabIndex")) && c.specified ? c.value : R.test(a.nodeName) || S.test(a.nodeName) && a.href ? 0 : b;
                    return a[c]
                }
                if (!q.support.style && e && c === "style") {
                    if (f) a.style.cssText = "" + d;
                    return a.style.cssText
                } f && a.setAttribute(c, "" + d); a = !q.support.hrefNormalized && e && g ? a.getAttribute(c, 2) : a.getAttribute(c);
                return a === null ? b : a
            } return q.style(a, c, d)
        }
    });
    var U = /\.(.*)$/, V = function(a) { return a.replace(/[^\w\s\.\|`]/g, function(a) { return "\\" + a }) };
    q.event = { add: function(c, d, e, f) {
        if (!(c.nodeType === 3 || c.nodeType === 8)) {
            if (c.setInterval && c !== a && !c.frameElement) c = a;
            var g, h; if (e.handler) { g = e; e = g.handler }
            if (!e.guid) e.guid = q.guid++;
            if (h = q.data(c)) {
                var i = h.events = h.events || {}, j = h.handle; if (!j) h.handle = j = function()
                { return typeof q !== "undefined" && !q.event.triggered ? q.event.handle.apply(j.elem, arguments) : b };
                j.elem = c; d = d.split(" ");
                for (var k, l = 0, m; k = d[l++]; ) {
                    h = g ? q.extend({}, g) : { handler: e, data: f }; if (k.indexOf(".") > -1) {
                        m = k.split(".");
                        k = m.shift(); h.namespace = m.slice(0).sort().join(".")
                    }
                    else { m = []; h.namespace = "" } h.type = k; h.guid = e.guid; var n = i[k], o = q.event.special[k] || {};
                    if (!n) {
                        n = i[k] = []; if (!o.setup || o.setup.call(c, f, m, j) === false)
                            if (c.addEventListener) c.addEventListener(k, j, false); else c.attachEvent && c.attachEvent("on" + k, j)
                    }
                    if (o.add) { o.add.call(c, h); if (!h.handler.guid) h.handler.guid = e.guid } n.push(h);
        ...
        if (!(a.nodeType === 3 || a.nodeType === 8)) {
            ...
            if (m && n) {
                if (b && b.type) { c = b.handler; b = b.type }
                if (!b || typeof b === "string" && b.charAt(0) === ".") {
                    ...
                    for (b = b.split(" "); e = b[f++]; ) {
                        ...
                        if (k = n[e]) if (c) {
                            ...
                            if (k.length === 0 || d != null && k.length === 1) {
                                if (!j.teardown || j.teardown.call(a, h) === false)
                                    W(a, e, m.handle); delete n[e]
                            }
                        }
                    ...
                    if (q.isEmptyObject(n)) {
                        if (b = m.handle) b.elem = null; delete m.events; delete m.handle;
        ...
        if (!e) {
            ...
            if (f.indexOf("!") >= 0) { a.type = f = f.slice(0, -1); a.exclusive = true }
            if (!d) {
                a.stopPropagation(); q.event.global[f] && q.each(q.cache, function()
        ...
        (e = q.data(d, "handle")) && e.apply(d, c); e = d.parentNode || d.ownerDocument;
        try {
            if (!(d && d.nodeName && q.noData[d.nodeName.toLowerCase()]))
                if (d["on" + f] && d["on" + f].apply(d, c) === false) a.result = false
        } catch (g) { }
        if (!a.isPropagationStopped() && e) q.event.trigger(a, c, e, true);
        else if (!a.isDefaultPrevented()) {
            e = a.target; var h, i = q.nodeName(e, "a") && f === "click", j = q.event.special[f] || {};
            if ((!j._default || j._default.call(d, a) === false) && !i && !(e && e.nodeName && q.noData[e.nodeName.toLowerCase()])) {
                try {
                    if (e[f]) {
                        if (h = e["on" + f]) e["on" + f] = null; q.event.triggered = true;
                        e[f]()
                    }
                } catch (k) { }
                if (h) e["on" + f] = h; q.event.triggered = false
            }
        }
    }, handle: function(c) {
        var d, e, f, g; c = arguments[0] = q.event.fix(c || a.event); c.currentTarget = this;
        d = c.type.indexOf(".") < 0 && !c.exclusive;
        if (!d) {
            e = c.type.split("."); c.type = e.shift();
        ...
        e = g[c.type]; if (g && e) {
            ...
            for (var h = e.length; g < h; g++) {
                ...
                if (d || f.test(i.namespace)) {
                    ...
                    if (i !== b) { c.result = i; if (i === false) { c.preventDefault(); c.stopPropagation() } }
        ...
        props: "altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY originalTarget pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".split(" "), fix: function(a) {
            if (a[J]) return a; var c = a; a = q.Event(c);
            ...
            if (a.pageX == null && a.clientX != null) {
                c = t.documentElement; d = t.body; a.pageX = a.clientX + (c && c.scrollLeft || d && d.scrollLeft || 0) - (c && c.clientLeft || d && d.clientLeft || 0);
            ...
            return a
        }, guid: 1e8, proxy: q.proxy, special: { ready: { setup: q.bindReady, teardown: q.noop }, live: { add: function(a)
        { q.event.add(this, a.origType, q.extend({}, a, { handler: j })) }, remove: function(a) {
            var b = true, c = a.origType.replace(U, ""); q.each(q.data(this, "events").live || [], function()
            { if (c === this.origType.replace(U, "")) return b = false });
            b && q.event.remove(this, a.origType, j)
        }
        }, beforeunload: { setup: function(a, b, c)
        { if (this.setInterval) this.onbeforeunload = c; return false }, teardown: function(a, b)
        { if (this.onbeforeunload === b) this.onbeforeunload = null } 
        }
        }
    };
    var W = t.removeEventListener ? function(a, b, c) { a.removeEventListener(b, c, false) } : function(a, b, c)
    { a.detachEvent("on" + b, c) }; q.Event = function(a) {
        if (!this.preventDefault) return new q.Event(a);
        if (a && a.type) { this.originalEvent = a; this.type = a.type } else this.type = a; this.timeStamp = f();
        this[J] = true
    }; q.Event.prototype = { preventDefault: function() {
        this.isDefaultPrevented = h; var a = this.originalEvent;
        if (a) { a.preventDefault && a.preventDefault(); a.returnValue = false }
    }, stopPropagation: function() {
        this.isPropagationStopped = h; var a = this.originalEvent;
    ...
    var X = function(a) {
        var b = a.relatedTarget; try {
            ...
            if (b !== this) { a.type = a.data; q.event.handle.apply(this, arguments) }
        } catch (c) { }
    }, Y = function(a)
    { a.type = a.data; q.event.handle.apply(this, arguments) };
    q.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function(a, b) {
        q.event.special[a] = { setup: function(c)
        { q.event.add(this, b, c && c.selector ? Y : X, a) }, teardown: function(a)
        { q.event.remove(this, b, a && a.selector ? Y : X) }
        }
    });
    if (!q.support.submitBubbles) q.event.special.submit = { setup: function() {
    ...
    if (!q.support.changeBubbles) {
        var Z = /textarea|input|select/i, $, _ = function(a) {
            var b = a.type, c = a.value; if (b === "radio" || b === "checkbox") c = a.checked;
            else if (b === "select-multiple") c = a.selectedIndex > -1 ? q.map(a.options, function(a)
            { return a.selected }).join("-") : ""; else if (a.nodeName.toLowerCase() === "select") c = a.selectedIndex;
            return c
        }, ba = function(a, c) {
            var d = a.target, e, f;
            if (!(!Z.test(d.nodeName) || d.readOnly)) {
                e = q.data(d, "_change_data"); f = _(d);
                if (a.type !== "focusout" || d.type !== "radio") q.data(d, "_change_data", f);
                if (!(e === b || f === e)) if (e != null || f) { a.type = "change"; return q.event.trigger(a, c, d) }
            }
        };
        q.event.special.change = { filters: { focusout: ba, click: function(a) {
            var b = a.target, c = b.type;
        ...
        { a = a.target; q.data(a, "_change_data", _(a)) }
            ...
            if (this.type === "file") return false; for (var a in $) q.event.add(this, a + ".specialChange", $[a]);
    ...
    } t.addEventListener && q.each({ focus: "focusin", blur: "focusout" },
     function(a, b) {
         function c(a) {
             a = q.event.fix(a); a.type = b;
             return q.event.handle.call(this, a)
         } q.event.special[b] = { setup: function()
         { this.addEventListener(a, c, true) }, teardown: function() { this.removeEventListener(a, c, true) }
         }
     });
    q.each(["bind", "one"], function(a, c) {
        q.fn[c] = function(a, d, e) {
            ...
            if (q.isFunction(d)) { e = d; d = b }
            var g = c === "one" ? q.proxy(e, function(a)
            { q(this).unbind(a, g); return e.apply(this, arguments) }) : e;
    ...
    q.fn.extend({ unbind: function(a, b) {
        ...
        { return this.each(function() { q.event.trigger(a, b, this) }) }, triggerHandler: function(a, b) {
            if (this[0]) {
                a = q.Event(a); a.preventDefault(); a.stopPropagation(); q.event.trigger(a, b, this[0]);
                return a.result
            }
        }, toggle: function(a) {
            for (var b = arguments, c = 1; c < b.length; ) q.proxy(a, b[c++]);
            return this.click(q.proxy(a, function(d) {
                var e = (q.data(this, "lastToggle" + a.guid) || 0) % c; q.data(this, "lastToggle" + a.guid, e + 1);
                d.preventDefault(); return b[e].apply(this, arguments) || false
            }))
        }, hover: function(a, b)
        { return this.mouseenter(a).mouseleave(b || a) }
    });
    var bb = { focus: "focusin", blur: "focusout", mouseenter: "mouseover", mouseleave: "mouseout" };
    q.each(["live", "die"], function(a, c) {
        q.fn[c] = function(a, d, e, f) {
            var g, h = 0, i, j, l = f || this.selector, m = f ? this : q(this.context); if (q.isFunction(d))
            { e = d; d = b } for (a = (a || "").split(" "); (g = a[h++]) != null; ) {
                f = U.exec(g); i = "";
                if (f) { i = f[0]; g = g.replace(U, "") } if (g === "hover") a.push("mouseenter" + i, "mouseleave" + i);
                else {
                    j = g; if (g === "focus" || g === "blur") { a.push(bb[g] + i); g += i }
                    else g = (bb[g] || g) + i; c === "live" ? m.each(function() {
                        q.event.add(this, k(g, l),
     { data: d, selector: l, handler: e, origType: g, origHandler: e, preType: j })
                    }) : m.unbind(k(g, l), e)
                }
            }
            return this
    ...
    { q.fn[b] = function(a) { return a ? this.bind(b, a) : this.trigger(b) }; if (q.attrFn) q.attrFn[b] = true });
    a.attachEvent && !a.addEventListener && a.attachEvent("onunload", function()
    { for (var a in q.cache) if (q.cache[a].handle) try { q.event.remove(q.cache[a].handle.elem) } catch (b) { } });
    (function() {
        function d(a, b, c, d, e, f) {
            e = 0; for (var g = d.length; e < g; e++) {
                var h = d[e]; if (h) {
                    h = h[a]; for (var i = false; h; ) {
                        if (h.sizcache === c) { i = d[h.sizset]; break }
                        if (h.nodeType === 1) {
                            if (!f) { h.sizcache = c; h.sizset = e }
                            if (typeof b !== "string") { if (h === b) { i = true; break } }
                            else if (j.filter(b, [h]).length > 0) { i = h; break }
                        } h = h[a]
                    } d[e] = i
                }
            }
            ...
            e = 0; for (var g = d.length; e < g; e++) {
                var h = d[e]; if (h) {
                    ...
                    for (var i = false; h; ) {
                        ...
                        if (h.nodeName.toLowerCase() === b) { i = h; break } h = h[a]
                    } d[e] = i
                }
            }
        } function a(b) {
        ...
        var e = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|['"][^'"]*['"]|[^[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, f = 0, g = Object.prototype.toString, h = false, i = true; [0, 0].sort(function()
        { i = false; return 0 }); var j = function(a, b, c, d) {
            c = c || []; var f = b = b || t; if (b.nodeType !== 1 && b.nodeType !== 9) return [];
            if (!a || typeof a !== "string") return c;
            for (var h = [], i, m, o, p, q = true, v = s(b), w = a; (e.exec(""), i = e.exec(w)) !== null; ) { w = i[3]; h.push(i[1]); if (i[2]) { p = i[3]; break } } if (h.length > 1 && l.exec(a)) if (h.length === 2 && k.relative[h[0]]) m = u(h[0] + h[1], b);
            else for (m = k.relative[h[0]] ? [b] : j(h.shift(), b); h.length; ) {
                a = h.shift();
                if (k.relative[a]) a += h.shift(); m = u(a, m)
            } else {
                if (!d && h.length > 1 && b.nodeType === 9 && !v && k.match.ID.test(h[0]) && !k.match.ID.test(h[h.length - 1])) { i = j.find(h.shift(), b, v); b = i.expr ? j.filter(i.expr, i.set)[0] : i.set[0] }
                if (b) {
                    i = d ? { expr: h.pop(), set: n(d)} : j.find(h.pop(), h.length === 1 && (h[0] === "~" || h[0] === "+") && b.parentNode ? b.parentNode : b, v); m = i.expr ? j.filter(i.expr, i.set) : i.set; if (h.length > 0) o = n(m); else q = false;
                    for (; h.length; ) {
                        var x = h.pop(); i = x; if (k.relative[x]) i = h.pop(); else x = "";
                        if (i == null) i = b; k.relative[x](o, i, v)
                    }
                }
                else o = []
            } o || (o = m); o || j.error(x || a); if (g.call(o) === "[object Array]")
                if (q) if (b && b.nodeType === 1)
                for (a = 0; o[a] != null; a++)
            { if (o[a] && (o[a] === true || o[a].nodeType === 1 && r(b, o[a]))) c.push(m[a]) }
            else for (a = 0; o[a] != null; a++) o[a] && o[a].nodeType === 1 && c.push(m[a]);
            else c.push.apply(c, o); else n(o, c);
            if (p) { j(p, f, c, d); j.uniqueSort(c) } return c
        ...
        j.matches = function(a, b) { return j(a, null, null, b) }; j.find = function(a, b, c) {
            var d, e; if (!a) return [];
            for (var f = 0, g = k.order.length; f < g; f++) {
                var h = k.order[f];
                if (e = k.leftMatch[h].exec(a)) {
                    var i = e[1]; e.splice(1, 1);
                    if (i.substr(i.length - 1) !== "\\") {
                        e[1] = (e[1] || "").replace(/\\/g, ""); d = k.find[h](e, b, c);
                        if (d != null) { a = a.replace(k.match[h], ""); break }
                    }
                }
        ...
        j.filter = function(a, c, d, e) {
            for (var f = a, g = [], h = c, i, l, m = c && c[0] && s(c[0]); a && c.length; ) {
                for (var n in k.filter)
                    if ((i = k.leftMatch[n].exec(a)) != null && i[2]) {
                    var o = k.filter[n], p, q; q = i[1]; l = false; i.splice(1, 1);
                    if (q.substr(q.length - 1) !== "\\") {
                        if (h === g) g = [];
                        if (k.preFilter[n]) if (i = k.preFilter[n](i, h, d, g, e, m))
                        { if (i === true) continue } else l = p = true;
                        if (i) for (var r = 0; (q = h[r]) != null; r++) if (q) {
                            p = o(q, i, r, h); var t = e ^ !!p; if (d && p != null)
                                if (t) l = true; else h[r] = false;
                            else if (t) { g.push(q); l = true }
                        }
                        if (p !== b) { d || (h = g); a = a.replace(k.match[n], ""); if (!l) return []; break }
                    }
                }
                if (a === f) if (l == null) j.error(a); else break; f = a
            } return h
        };
        j.error = function(a)
        { throw "Syntax error, unrecognized expression: " + a };
        var k = j.selectors = { order: ["ID", "NAME", "TAG"],
            match: { ID: /#((?:[\w\u00c0-\uFFFF-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*-]|\\.)+)/,
            ...
            { return a.getAttribute("href") }
                ...
                var c = typeof b === "string", d = c && !/\W/.test(b); c = c && !d; if (d) b = b.toLowerCase(); d = 0;
                for (var e = a.length, f; d < e; d++) if (f = a[d]) {
                    for (; (f = f.previousSibling) && f.nodeType !== 1; );
                    a[d] = c || f && f.nodeName.toLowerCase() === b ? f || false : f === b
                } c && j.filter(b, a, true)
            }, ">": function(a, b) {
                var c = typeof b === "string"; if (c && !/\W/.test(b)) {
                    b = b.toLowerCase();
                    for (var d = 0, e = a.length; d < e; d++) {
                        var f = a[d]; if (f)
                        { c = f.parentNode; a[d] = c.nodeName.toLowerCase() === b ? c : false }
                    }
                }
                else {
                    d = 0; for (e = a.length; d < e; d++)
                        if (f = a[d]) a[d] = c ? f.parentNode : f.parentNode === b; c && j.filter(b, a, true)
                }
            }, "": function(a, b, e) {
                var g = f++, h = d;
                if (typeof b === "string" && !/\W/.test(b)) { var i = b = b.toLowerCase(); h = c } h("parentNode", b, g, a, i, e)
            }, "~": function(a, b, e) {
                var g = f++, h = d; if (typeof b === "string" && !/\W/.test(b))
                { var i = b = b.toLowerCase(); h = c } h("previousSibling", b, g, a, i, e)
            }
            }, find: { ID: function(a, b, c)
            { if (typeof b.getElementById !== "undefined" && !c) return (a = b.getElementById(a[1])) ? [a] : [] }, NAME: function(a, b) {
                if (typeof b.getElementsByName !== "undefined") {
                    var c = []; b = b.getElementsByName(a[1]);
                    for (var d = 0, e = b.length; d < e; d++) b[d].getAttribute("name") === a[1] && c.push(b[d]); return c.length === 0 ? null : c
                }
            }, TAG: function(a, b)
            { return b.getElementsByTagName(a[1]) }
            }, preFilter: { CLASS: function(a, b, c, d, e, f) {
                a = " " + a[1].replace(/\\/g, "") + " "; if (f) return a; f = 0;
                for (var g; (g = b[f]) != null; f++)
                    if (g)
                    if (e ^ (g.className && (" " + g.className + " ").replace(/[\t\n]/g, " ").indexOf(a) >= 0)) c || d.push(g);
                else if (c) b[f] = false; return false
            }, ID: function(a)
            { return a[1].replace(/\\/g, "") }, TAG: function(a)
            { return a[1].toLowerCase() }, CHILD: function(a) {
                if (a[1] === "nth")
                { var b = /(-?)(\d*)n((?:\+|-)?\d*)/.exec(a[2] === "even" && "2n" || a[2] === "odd" && "2n+1" || !/\D/.test(a[2]) && "0n+" + a[2] || a[2]); a[2] = b[1] + (b[2] || 1) - 0; a[3] = b[3] - 0 } a[0] = f++; return a
            }, ATTR: function(a, b, c, d, e, f) {
                b = a[1].replace(/\\/g, "");
                if (!f && k.attrMap[b]) a[1] = k.attrMap[b]; if (a[2] === "~=") a[4] = " " + a[4] + " "; return a
            }, PSEUDO: function(a, b, c, d, f) {
                if (a[1] === "not")
                    if ((e.exec(a[3]) || "").length > 1 || /^\w/.test(a[3])) a[3] = j(a[3], null, null, b); else { a = j.filter(a[3], b, c, true ^ f); c || d.push.apply(d, a); return false } else if (k.match.POS.test(a[0]) || k.match.CHILD.test(a[0])) return true; return a
            }, POS: function(a) { a.unshift(true); return a }
            }, filters: { enabled: function(a) { return a.disabled === false && a.type !== "hidden" }, disabled: function(a) { return a.disabled === true }, checked: function(a) { return a.checked === true }, selected: function(a) { return a.selected === true }, parent: function(a) { return !!a.firstChild }, empty: function(a) { return !a.firstChild }, has: function(a, b, c) { return !!j(c[3], a).length }, header: function(a)
            ...
            { return c[3] - 0 === b }
                ...
                var f = c[1], g = k.filters[f]; if (g) return g(b, d, c, e);
                else if (f === "contains") return (b.textContent || b.innerText || a([b]) || "").indexOf(c[3]) >= 0;
                else if (f === "not") {
                    c = c[3]; d = 0; for (e = c.length; d < e; d++) if (c[d] === b) return false;
                    return true
                } else j.error("Syntax error, unrecognized expression: " + f)
            }, CHILD: function(a, b) {
                var c = b[1], d = a; switch (c) {
                    case "only": case "first": for (; d = d.previousSibling; )
                            if (d.nodeType === 1) return false; if (c === "first") return true;
                        d = a; case "last": for (; d = d.nextSibling; ) if (d.nodeType === 1) return false;
                        return true; case "nth": c = b[2]; var e = b[3]; if (c === 1 && e === 0) return true;
                        b = b[0]; var f = a.parentNode; if (f && (f.sizcache !== b || !a.nodeIndex)) {
                            var g = 0;
                            for (d = f.firstChild; d; d = d.nextSibling)
                                if (d.nodeType === 1) d.nodeIndex = ++g; f.sizcache = b
                        } a = a.nodeIndex - e;
            ...
            { return (" " + (a.className || a.getAttribute("class")) + " ").indexOf(b) > -1 }, ATTR: function(a, b) {
                var c = b[1]; a = k.attrHandle[c] ? k.attrHandle[c](a) : a[c] != null ? a[c] : a.getAttribute(c); c = a + "";
                var d = b[2]; b = b[4]; return a == null ? d === "!=" : d === "=" ? c === b : d === "*=" ? c.indexOf(b) >= 0 : d === "~=" ? (" " + c + " ").indexOf(b) >= 0 : !b ? c && a !== false : d === "!=" ? c !== b : d === "^=" ? c.indexOf(b) === 0 : d === "$=" ? c.substr(c.length - b.length) === b : d === "|=" ? c === b || c.substr(0, b.length + 1) === b + "-" : false
            }, POS: function(a, b, c, d)
            { var e = k.setFilters[b[2]]; if (e) return e(a, c, b, d) }
            }
        }, l = k.match.POS;
        for (var m in k.match) {
            k.match[m] = new RegExp(k.match[m].source + /(?![^\[]*\])(?![^\(]*\))/.source); k.leftMatch[m] = new RegExp(/(^(?:.|\r|\n)*?)/.source + k.match[m].source.replace(/\\(\d+)/g, function(a, b)
            { return "\\" + (b - 0 + 1) }))
        } var n = function(a, b)
        { a = Array.prototype.slice.call(a, 0); if (b) { b.push.apply(b, a); return b } return a };
        try { Array.prototype.slice.call(t.documentElement.childNodes, 0) } catch (o) {
            n = function(a, b) {
                b = b || []; if (g.call(a) === "[object Array]") Array.prototype.push.apply(b, a);
                else if (typeof a.length === "number") for (var c = 0, d = a.length; c < d; c++) b.push(a[c]);
                else for (c = 0; a[c]; c++) b.push(a[c]); return b
            }
        } var p;
        if (t.documentElement.compareDocumentPosition) p = function(a, b) {
            if (!a.compareDocumentPosition || !b.compareDocumentPosition)
            { if (a == b) h = true; return a.compareDocumentPosition ? -1 : 1 } a = a.compareDocumentPosition(b) & 4 ? -1 : a === b ? 0 : 1;
            if (a === 0) h = true; return a
        }; else if ("sourceIndex" in t.documentElement) p = function(a, b) {
            if (!a.sourceIndex || !b.sourceIndex) { if (a == b) h = true; return a.sourceIndex ? -1 : 1 } a = a.sourceIndex - b.sourceIndex;
            if (a === 0) h = true; return a
            ...
            var c = a.ownerDocument.createRange(), d = b.ownerDocument.createRange(); c.setStart(a, 0); c.setEnd(a, 0); d.setStart(b, 0); d.setEnd(b, 0); a = c.compareBoundaryPoints(Range.START_TO_END, d);
            if (a === 0) h = true; return a
        }; (function() {
            var a = t.createElement("div"), c = "script" + (new Date).getTime(); a.innerHTML = "<a name='" + c + "'/>";
            var d = t.documentElement; d.insertBefore(a, d.firstChild); if (t.getElementById(c)) {
                k.find.ID = function(a, c, d)
                { if (typeof c.getElementById !== "undefined" && !d) return (c = c.getElementById(a[1])) ? c.id === a[1] || typeof c.getAttributeNode !== "undefined" && c.getAttributeNode("id").nodeValue === a[1] ? [c] : b : [] }; k.filter.ID = function(a, b)
